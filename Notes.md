...
### Trigger an invalid ModelState

Send a `DeviceType` of `"1"`, which is shorter than 3 characters:
...
```json
{
  ...
  "traceId": "00-9a83f365e4b6d8d9dec583ed99cbb632-f63502de9383f8bc-00"
}
```
...
Disable the automatic interception in `Program.cs`:
...
Now your `if (ModelState.IsValid)` block runs. Remove this after testing.

#### BadRequest() — 400 with no field details
...
```json
{
  ...
  "title": "Bad Request",
  "status": 400,
  "traceId": "00-a33c234b88d5baee4d5daf643cd041b9-65c030e17d9dc957-00"
}
```

#### BadRequest(ModelState) — 400 with field-level errors
